...
public class PreCadastro {
	private static final String[] modelos = { "juliet", "aviador", "redondo", "quadrado", "esportivo", "aba reta",
			"aba torta", "viseira" };
	private static final String[] cor = { "azul", "preto", "verde", "roxo", "branco", "rosa", "vermelho", "laranja" };
	private static final int[] qntEstoque = { 1, 2, 3, 4, 5, 3, 4, 5 };
	private static final Long[] valor = { 10L, 15L, 20L, 25L, 30L, 20L, 30L, 40L };
	private static final Boolean[] tipoProdutos = { true, true, true, true, true, false, false, false };
	...
	private static final String[] telefones = { "(61)87170784", "(61)83469070", "(61)86584869", "(61)84325776",
			"(61)84268100" };
	...
	public static void preCadastro() {
		...
		for (int i = 0; i < 5; i++) {
			...
			cliente.setNomeCliente(nomes[i]);
			cliente.setCpf(cpfs[i]);
			cliente.setCep(ceps[i]);
			cliente.setTelefone(telefones[i]);
		}
